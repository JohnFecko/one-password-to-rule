...
const patchEsm = () => {
  ...
  if (!(win.CSS && win.CSS.supports && win.CSS.supports("color", "var(--c)"))) {
    // @ts-ignore
    return new Promise(function(resolve) {
      resolve(require("./css-shim-3ea8955c-8b902b6b.js"));
    });
  }
  ...
  const importMeta =
    typeof document === "undefined"
      ...
      : (document.currentScript && document.currentScript.src) ||
        new URL("core-be19e9c2.js", document.baseURI).href;
  const regex = new RegExp(`\/${NAMESPACE}(\\.esm)?\\.js($|\\?|#)`);
  const scriptElm = Array.from(doc.querySelectorAll("script")).find(
    s => regex.test(s.src) || s.getAttribute("data-namespace") === NAMESPACE
  );
  ...
  if (importMeta !== "") {
    ...
    if (!window.customElements) {
      ...
      await new Promise(function(resolve) {
        resolve(require("./dom-860d8016-0ebf8707.js"));
      });
    }
      ...
      if (
        ...
        Object.defineProperty(prototype, memberName, {
          value(...args) {
            ...
            return ref.$onReadyPromise$.then(() =>
...
const initializeComponent = async (
  ...
  if ((hostRef.$flags$ & 32) /* hasInitializedComponent */ === 0) {
    ...
    if (hostRef.$modeName$ == null) {
      ...
      hostRef.$modeName$ =
        typeof cmpMeta.$lazyBundleIds$ !== "string" ? computeMode(elm) : "";
    }
    {
    ...
    if (!Cstr.$isStyleRegistered$ && Cstr.style) {
      ...
      const runtimeScopedCss =
        BUILD.runtimeScopeCss /* scopedCssEncapsulation */;
      if (shadowCssPolyfill || runtimeScopedCss) {
        style = await new Promise(function(resolve) {
          resolve(require("./shadow-css-9e778f69-0a34c9e7.js"));
...
const connectedCallback = (elm, cmpMeta) => {
  if ((plt.$flags$ & 1) /* isTmpDisconnected */ === 0) {
    ...
    if (cmpMeta.$listeners$) {
      ...
      hostRef.$rmListeners$ = addEventListeners(
        elm,
        hostRef,
        cmpMeta.$listeners$
      );
