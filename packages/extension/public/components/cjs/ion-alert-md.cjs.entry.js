...
const index = require("./index-8f56dc04.js");
...
const Alert = class {
  ...
  renderCheckbox(labelledby) {
    ...
    return core.h(
      "div",
      { class: "alert-checkbox-group", "aria-labelledby": labelledby },
      inputs.map(i =>
        core.h(
          "button",
          {
          ...
          core.h(
            ...
            core.h(
              ...
              core.h("div", { class: "alert-checkbox-inner" })
            ),
            core.h("div", { class: "alert-checkbox-label" }, i.label)
          ),
        ...
        core.h(
          ...
          core.h(
            ...
            core.h(
              ...
              core.h("div", { class: "alert-radio-inner" })
            ),
            core.h("div", { class: "alert-radio-label" }, i.label)
          )
        )
      )
    );
  ...
  renderInput(labelledby) {
    ...
    return core.h(
      "div",
      { class: "alert-input-group", "aria-labelledby": labelledby },
      inputs.map(i =>
        core.h(
          "div",
    ...
    return core.h(
      ...
      buttons.map(button =>
        core.h(
          ...
          core.h("span", { class: "alert-button-inner" }, button.text),
          mode === "md" && core.h("ion-ripple-effect", null)
        )
      )
    );
  ...
  render() {
    ...
    return core.h(
      core.Host,
      {
        ...
        class: Object.assign({}, theme.getClassMap(this.cssClass), {
          [mode]: true,
      ...
      core.h(
        ...
        core.h(
          "div",
          { class: "alert-head" },
          header && core.h("h2", { id: hdrId, class: "alert-title" }, header),
          subHeader &&
            core.h("h2", { id: subHdrId, class: "alert-sub-title" }, subHeader)
        ),
        core.h("div", {
          id: msgId,
          class: "alert-message",
          innerHTML: index.sanitizeDOMString(this.message)
        }),
...
const buttonClass = button => {
  return Object.assign(
    { "alert-button": true, "ion-focusable": true, "ion-activatable": true },
