...
const BackButton = class {
  ...
  get backButtonIcon() {
    return this.icon != null
      ? this.icon
      : core.config.get("backButtonIcon", "arrow-back");
  }
  get backButtonText() {
    const defaultBackButtonText = this.mode === "ios" ? "Back" : null;
    return this.text != null
      ? this.text
      : core.config.get("backButtonText", defaultBackButtonText);
  }
  get hasIconOnly() {
  ...
  render() {
    ...
    return core.h(
      ...
      core.h(
        "button",
        { type: type, disabled: disabled, class: "button-native" },
        core.h(
          "span",
          { class: "button-inner" },
          backButtonIcon &&
            core.h("ion-icon", { icon: backButtonIcon, lazy: false }),
          backButtonText &&
            core.h("span", { class: "button-text" }, backButtonText)
        ),
        mode === "md" && core.h("ion-ripple-effect", { type: this.rippleType })
      )
    );
  }
  get el() {
