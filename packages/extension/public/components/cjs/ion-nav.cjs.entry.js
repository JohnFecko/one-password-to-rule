...
class ViewController {
  ...
  async init(container) {
    ...
    if (!this.element) {
      ...
      this.element = await frameworkDelegate.attachComponent(
        this.delegate,
        container,
        component,
...
const Nav = class {
  ...
  componentWillLoad() {
    ...
    if (this.swipeGesture === undefined) {
      ...
      this.swipeGesture = core.config.getBoolean(
        "swipeBackEnabled",
        mode === "ios"
      );
    }
    ...
    const animationOpts = Object.assign(
      {
        ...
        progressCallback,
        animated: this.animated && core.config.getBoolean("animated", true),
        enteringEl,
        leavingEl
      },
      opts
