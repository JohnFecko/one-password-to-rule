...
const Picker = class {
  ...
  buttonClick(button) {
    ...
    const shouldDismiss =
      overlays.safeCall(button.handler, this.getSelected()) !== false;
    if (shouldDismiss) {
      return this.dismiss();
    }
    ...
    return core.h(
      ...
      core.h(
        ...
        core.h(
          ...
          core.h("div", { class: "picker-above-highlight" }),
          this.presented &&
            this.columns.map(c => core.h("ion-picker-column", { col: c })),
          core.h("div", { class: "picker-below-highlight" })
        )
      )
    );
  }
