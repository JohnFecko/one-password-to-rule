...
const Popover = class {
  ...
  async present() {
    ...
    this.usersElement = await frameworkDelegate.attachComponent(
      this.delegate,
      container,
      this.component,
  ...
  async dismiss(data, role) {
    const shouldDismiss = await overlays.dismiss(
      this,
      data,
      role,
      "popoverLeave",
  ...
  render() {
    ...
    return core.h(
      ...
      core.h(
        ...
        core.h("div", { class: "popover-arrow" }),
        core.h("div", { class: "popover-content" })
      )
    );
  }
  get el() {
