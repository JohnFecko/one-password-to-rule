...
const Router = class {
  ...
  componentDidLoad() {
    window.addEventListener(
      ...
      helpers.debounce(this.onRedirectChanged.bind(this), 10)
    );
    window.addEventListener(
      "ionRouteDataChanged",
      helpers.debounce(this.onRoutesChanged.bind(this), 100)
    );
  }
  onPopState() {
