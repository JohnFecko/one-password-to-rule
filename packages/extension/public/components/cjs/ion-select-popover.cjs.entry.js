    ...
    return core.h(
      ...
      core.h(
        ...
        this.header !== undefined &&
          core.h("ion-list-header", null, this.header),
          ...
          core.h(
            ...
            core.h(
              ...
              this.subHeader !== undefined &&
                core.h("h3", null, this.subHeader),
              this.message !== undefined && core.h("p", null, this.message)
            )
          ),
        core.h(
          "ion-radio-group",
          ...
          this.options.map(option =>
            core.h(
              "ion-item",
              null,
              core.h("ion-label", null, option.text),
              core.h("ion-radio", {
