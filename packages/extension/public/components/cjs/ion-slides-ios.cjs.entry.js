...
const Slides = class {
  constructor(hostRef) {
    ...
    this.ionSlideTransitionStart = core.createEvent(
      this,
      "ionSlideTransitionStart",
      7
    );
    this.ionSlideTransitionEnd = core.createEvent(
      this,
  ...
  async initSwiper() {
    ...
    // init swiper core
    // @ts-ignore
    const { Swiper } = await new Promise(function(resolve) {
      resolve(require("./swiper.bundle-b5f43e8c.js"));
    });
  ...
  render() {
    ...
    return core.h(
      ...
      core.h("div", { class: "swiper-wrapper" }, core.h("slot", null)),
      this.pager &&
        core.h("div", {
