...
var loadModule = function(cmpMeta, hostRef, hmrVersionId) {
  ...
  var bundleId =
    typeof cmpMeta.$lazyBundleIds$ !== "string"
...
var flush = function() {
  ...
  if (
    (queuePending =
      queueDomReads.length + queueDomWrites.length + queueDomWritesLow.length >
      0)
  ) {
    ...
    return __generator(this, function(_a) {
      switch (_a.label) {
        case 0:
          ...
          scriptElm = Array.from(doc.querySelectorAll("script")).find(function(
            s
          ) {
            return (
              regex.test(s.src) ||
        ...
        case 3:
          return [
            2 /*return*/,
            Object.assign({}, opts, { resourcesUrl: resourcesUrl.href })
          ];
      }
    });
  });
  ...
  try {
    ...
    win[importFunctionName] = function(src) {
      ...
      if (!mod) {
        ...
        script_1.src = URL.createObjectURL(
          new Blob(
            [
              "import * as m from '" +
                url +
  ...
  if (style) {
    if (typeof style === "string") {
      ...
      if (!appliedStyles.has(scopeId)) {
        {
          if (cssVarShim) {
            styleElm = cssVarShim.createHostStyle(
              hostElm,
              scopeId,
              style,
...
var attachStyles = function(elm, cmpMeta, mode) {
  var styleId = addStyle(
    supportsShadowDom && elm.shadowRoot ? elm.shadowRoot : elm.getRootNode(),
    cmpMeta,
    mode,
    elm
  );
...
var setAccessor = function(elm, memberName, oldValue, newValue, isSvg, flags) {
  ...
  if (memberName === "class") {
    ...
    parseClassList(oldValue).forEach(function(cls) {
      return classList_1.remove(cls);
    });
    parseClassList(newValue).forEach(function(cls) {
      return classList_1.add(cls);
    });
     ...
     */
    var isXlinkNs =
      isSvg && memberName !== (memberName = memberName.replace(/^xlink\:?/, ""))
        ? true
        : false;
...
var parseClassList = function(value) {
  return !value
    ? []
    : value.split(/\s+/).filter(function(c) {
        return c;
      });
};
...
var addVnodes = function(
  ...
  if (
    ...
    toLowerCase(containerElm.tagName) === hostTagName
  ) {
...
var patch = function(oldVNode, newVNode) {
  ...
  var defaultHolder;
  {
    ...
    isSvgMode =
      elm && isDef(elm.parentNode) && elm.ownerSVGElement !== undefined;
    isSvgMode =
      newVNode.$tag$ === "svg"
        ? true
        : newVNode.$tag$ === "foreignObject"
...
var updateFallbackSlotVisibility = function(
  elm,
  childNode,
  childNodes,
  i,
...
var callNodeRefs = function(vNode, isDestroy) {
  if (vNode) {
    vNode.$attrs$ &&
      vNode.$attrs$.ref &&
      vNode.$attrs$.ref(isDestroy ? null : vNode.$elm$);
    vNode.$children$ &&
      vNode.$children$.forEach(function(vChild) {
...
var postUpdateComponent = function(
  elm,
  hostRef,
  ancestorsActivelyLoadingChildren
) {
  if (!elm["s-al"]) {
    var instance = hostRef.$lazyInstance$;
        ...
        if (watchMethods) {
          ...
          watchMethods.forEach(function(watchMethodName) {
            try {
              ...
              hostRef.$lazyInstance$[watchMethodName].call(
...
var proxyComponent = function(Cstr, cmpMeta, flags) {
  if (cmpMeta.$members$) {
    ...
    if (flags & 1 /* isElementConstructor */) {
      ...
      prototype_1.attributeChangedCallback = function(
        attrName,
        _oldValue,
        newValue
      ) {
        ...
        plt.jmp(function() {
          ...
          _this[propName] =
            newValue === null && typeof _this[propName] === "boolean"
              ? false
              : newValue;
        });
      };
...
var getHostListenerTarget = function(elm, flags) {
  ...
  if (flags & 16 /* TargetParent */) return elm.parentElement;
  return elm;
};
    ...
    return __generator(this, function(_a) {
      switch (_a.label) {
        ...
        case 2:
          ...
          return [
            4 /*yield*/,
            import("./shadow-css-9e778f69-c68d0961.js").then(function(m) {
...
var connectedCallback = function(elm, cmpMeta) {
  if ((plt.$flags$ & 1) /* isTmpDisconnected */ === 0) {
    ...
    if (cmpMeta.$listeners$) {
      ...
      hostRef_2.$rmListeners$ = addEventListeners(
        elm,
        hostRef_2,
        cmpMeta.$listeners$
      );
    ...
    if (!(hostRef_2.$flags$ & 1) /* hasConnected */) {
      ...
      }
      {
        ...
        while (
          ...
          if (
            ...
            (ancestorComponent["s-al"] =
              ancestorComponent["s-al"] || new Set()).add(elm);
            break;
          }
        }
      }
      ...
      }
      {
        ...
        nextTick(function() {
          return initializeComponent(elm, hostRef_2, cmpMeta);
        });
      }
    }
...
var getPlatforms = function(win) {
  return setupPlatforms(win);
};
var isPlatform = function(win, platform) {
  return getPlatforms(win).indexOf(platform) > -1;
};
