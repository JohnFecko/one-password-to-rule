...
var _this = this;
import { w as writeTask } from "./core-9991b89e.js";
...
var iosTransitionAnimation = function() {
  return import("./ios.transition-bdc3a806.js");
};
var mdTransitionAnimation = function() {
  return import("./md.transition-3ed08426.js");
};
...
var runTransition = function(opts) {
  return __awaiter(_this, void 0, void 0, function() {
    ...
    return __generator(this, function(_a) {
      switch (_a.label) {
        case 0:
          return [4 /*yield*/, getAnimationBuilder(opts)];
        case 1:
    ...
    return __generator(this, function(_b) {
      switch (_b.label) {
        ...
        case 1:
          ...
          return [3 /*break*/, 4];
        case 2:
          return [4 /*yield*/, mdTransitionAnimation()];
        case 3:
...
var animation = function(animationBuilder, opts) {
  return __awaiter(_this, void 0, void 0, function() {
    ...
    return __generator(this, function(_a) {
      switch (_a.label) {
        case 0:
          return [4 /*yield*/, waitForReady(opts, true)];
        case 1:
          _a.sent();
          return [
            4 /*yield*/,
...
export {
  LIFECYCLE_WILL_UNLOAD as L,
  LIFECYCLE_WILL_LEAVE as a,
  LIFECYCLE_DID_LEAVE as b,
  deepReady as d,
  lifecycle as l,
  setPageHidden as s,
  transition as t
