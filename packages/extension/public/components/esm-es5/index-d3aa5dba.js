...
var Animator = /** @class */ (function() {
  ...
  Animator.prototype.to = function(prop, val, clearProperyAfterTransition) {
    ...
    if (clearProperyAfterTransition) {
      ...
      this.afterClearStyles(
        fx.trans ? ["transform", "-webkit-transform"] : [prop]
      );
    }
    return this;
  };
   ...
   */
  Animator.prototype.fromTo = function(
    prop,
    fromVal,
    toVal,
  ...
  Animator.prototype.afterClearStyles = function(propertyNames) {
    ...
    for (
      var _i = 0, propertyNames_2 = propertyNames;
      _i < propertyNames_2.length;
      _i++
    ) {
  ...
  Animator.prototype._setBeforeStyles = function() {
    ...
    for (var _a = 0, elements_2 = elements; _a < elements_2.length; _a++) {
      ...
      if (addClasses) {
        for (
          var _b = 0, addClasses_1 = addClasses;
          _b < addClasses_1.length;
          _b++
        ) {
      ...
      if (removeClasses) {
        for (
          var _c = 0, removeClasses_1 = removeClasses;
          _c < removeClasses_1.length;
          _c++
        ) {
      ...
      if (this._beforeStyles) {
        for (
          var _d = 0, _e = Object.entries(this._beforeStyles);
          _d < _e.length;
          _d++
        ) {
          var _f = _e[_d],
  ...
  Animator.prototype._fireBeforeReadFunc = function() {
    ...
    if (readFunctions) {
      for (
        var _a = 0, readFunctions_1 = readFunctions;
        _a < readFunctions_1.length;
        _a++
      ) {
  ...
  Animator.prototype._fireBeforeWriteFunc = function() {
    ...
    if (writeFunctions) {
      for (
        var _a = 0, writeFunctions_1 = writeFunctions;
        _a < writeFunctions_1.length;
        _a++
      ) {
  ...
  Animator.prototype._setAfterStyles = function() {
    ...
    for (var _i = 0, elements_3 = elements; _i < elements_3.length; _i++) {
      ...
      if (this._isReverse) {
        ...
        if (beforeAddClasses) {
          for (
            var _a = 0, beforeAddClasses_1 = beforeAddClasses;
            _a < beforeAddClasses_1.length;
            _a++
          ) {
        ...
        if (beforeRemoveClasses) {
          for (
            var _b = 0, beforeRemoveClasses_1 = beforeRemoveClasses;
            _b < beforeRemoveClasses_1.length;
            _b++
          ) {
        ...
        if (beforeStyles) {
          for (
            var _c = 0, _d = Object.keys(beforeStyles);
            _c < _d.length;
            _c++
          ) {
            var propName = _d[_c];
        ...
        if (afterAddClasses) {
          for (
            var _e = 0, afterAddClasses_1 = afterAddClasses;
            _e < afterAddClasses_1.length;
            _e++
          ) {
        ...
        if (afterRemoveClasses) {
          for (
            var _f = 0, afterRemoveClasses_1 = afterRemoveClasses;
            _f < afterRemoveClasses_1.length;
            _f++
          ) {
        ...
        if (afterStyles) {
          for (
            var _g = 0, _h = Object.entries(afterStyles);
            _g < _h.length;
            _g++
          ) {
            var _j = _h[_g],
   ...
   */
  Animator.prototype.progressEnd = function(
    shouldComplete,
    currentStepValue,
    dur
  ) {
   ...
   * RECURSION
   */
  Animator.prototype._progressEnd = function(
    shouldComplete,
    stepValue,
    dur,
    isAsync
   ...
   * RECURSION
   */
  Animator.prototype._didFinishAll = function(
    hasCompleted,
  ...
  Animator.prototype._didFinish = function(hasCompleted) {
    ...
    if (this._onFinishOneTimeCallbacks) {
      ...
      for (
        var _b = 0, _c = this._onFinishOneTimeCallbacks;
        _b < _c.length;
        _b++
      ) {
        var callback = _c[_b];
