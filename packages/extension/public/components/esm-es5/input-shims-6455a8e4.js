import { p as pointerCoord } from "./helpers-18f3dc7c.js";
var cloneMap = new WeakMap();
var relocateInput = function(
  componentEl,
  inputEl,
  shouldRelocate,
  inputRelativeY
...
var calcScrollData = function(
  ...
  var visibleAreaBottom = Math.min(
    contentRect.bottom,
  ...
  var desiredScrollAmount = Math.round(
    distanceToBottom < 0
      ? -distanceToBottom
      : distanceToTop > 0
      ? -distanceToTop
...
var enableScrollAssist = function(
  componentEl,
  inputEl,
  contentEl,
  keyboardHeight
...
var startInputShims = function(config) {
  ...
  var registerInput = function(componentEl) {
    var inputEl =
      (componentEl.shadowRoot || componentEl).querySelector("input") ||
      (componentEl.shadowRoot || componentEl).querySelector("textarea");
