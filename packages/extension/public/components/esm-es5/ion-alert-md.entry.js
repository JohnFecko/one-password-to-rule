...
var Alert = /** @class */ (function() {
    ...
    if (inputTypes.has("checkbox") && inputTypes.has("radio")) {
      console.warn(
        "Alert cannot mix input types: " +
          Array.from(inputTypes.values()).join("/") +
  ...
  class_1.prototype.buttonClick = function(button) {
    ...
    if (returnData !== false) {
      return this.dismiss(
        Object.assign({ values: values }, returnData),
        button.role
      );
    }
    ...
    return h(
      Host,
      {
        ...
        class: Object.assign(
          ...
          ((_a = {}),
          (_a[mode] = true),
          (_a["alert-translucent"] = this.translucent),
          _a)
        ),
      ...
      h(
        ...
        h(
          ...
          subHeader &&
            h("h2", { id: subHdrId, class: "alert-sub-title" }, subHeader)
        ),
        h("div", {
          id: msgId,
          class: "alert-message",
