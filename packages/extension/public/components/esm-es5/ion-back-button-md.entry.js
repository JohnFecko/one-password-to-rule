...
var BackButton = /** @class */ (function() {
  ...
  Object.defineProperty(class_1.prototype, "backButtonIcon", {
    get: function() {
      return this.icon != null
        ? this.icon
        : config.get("backButtonIcon", "arrow-back");
    },
    enumerable: true,
    configurable: true
  });
  Object.defineProperty(class_1.prototype, "backButtonText", {
    get: function() {
      ...
      return this.text != null
        ? this.text
        : config.get("backButtonText", defaultBackButtonText);
    },
    enumerable: true,
    configurable: true
  });
  ...
  class_1.prototype.render = function() {
    ...
    var _b = this,
      color = _b.color,
      defaultHref = _b.defaultHref,
      disabled = _b.disabled,
      type = _b.type,
      mode = _b.mode,
      hasIconOnly = _b.hasIconOnly,
      backButtonIcon = _b.backButtonIcon,
      backButtonText = _b.backButtonText;
    ...
    return h(
      ...
      h(
        ...
        h(
          ...
          { class: "button-inner" },
          backButtonIcon &&
            h("ion-icon", { icon: backButtonIcon, lazy: false }),
