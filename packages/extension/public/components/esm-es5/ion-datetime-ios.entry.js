...
import { b as pickerController } from "./overlays-6ba59a1a.js";
import {
  c as clamp,
  f as findItemLabel,
  a as renderHiddenInput
} from "./helpers-18f3dc7c.js";
...
var Datetime = /** @class */ (function() {
  ...
  class_1.prototype.componentWillLoad = function() {
    ...
    this.locale = {
      ...
      dayShortNames: convertToArrayOfStrings(
        this.dayShortNames,
        "dayShortNames"
      )
    };
  ...
  class_1.prototype.generatePickerOptions = function() {
    ...
    var pickerOptions = Object.assign({ mode: mode }, this.pickerOptions, {
  ...
  class_1.prototype.validateColumns = function(columns) {
    ...
    if (yearCol) {
      ...
      if (
        !yearCol.options.find(function(col) {
    ...
    var selectedMonth = this.validateColumn(
      columns,
      "month",
      1,
      minCompareVal,
    ...
    var selectedDay = this.validateColumn(
      columns,
      "day",
      2,
      minCompareVal,
    ...
    var selectedHour = this.validateColumn(
      columns,
      "hour",
      3,
      minCompareVal,
  ...
  class_1.prototype.validateColumn = function(
    columns,
    name,
    index,
    min,
    ...
    var selectedIndex = (column.selectedIndex = clamp(
      indexMin,
  ...
  class_1.prototype.render = function() {
    ...
    var addPlaceholderClass =
      text === undefined && placeholder != null ? true : false;
