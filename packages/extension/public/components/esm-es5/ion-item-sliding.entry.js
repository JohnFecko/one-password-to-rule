...
import { i as isEndSide } from "./helpers-18f3dc7c.js";
var SWIPE_MARGIN = 30;
    ...
    return __awaiter(this, void 0, void 0, function() {
      ...
      return __generator(this, function(_a) {
        ...
        requestAnimationFrame(function() {
          ...
          var width =
            side === "end"
              ? _this.optsWidthRightSide
              : -_this.optsWidthLeftSide;
  ...
  class_1.prototype.render = function() {
    ...
    return h(Host, {
      class:
        ...
        (_a["item-sliding-active-options-end"] =
          (this.state & 8) /* End */ !== 0),
        (_a["item-sliding-active-options-start"] =
          (this.state & 16) /* Start */ !== 0),
        (_a["item-sliding-active-swipe-end"] =
          (this.state & 32) /* SwipeEnd */ !== 0),
        (_a["item-sliding-active-swipe-start"] =
          (this.state & 64) /* SwipeStart */ !== 0),
        _a)
    });
  };
