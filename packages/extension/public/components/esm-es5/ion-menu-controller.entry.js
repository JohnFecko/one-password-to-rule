...
import { r as registerInstance, c as config } from "./core-9991b89e.js";
/**
 * baseAnimation
...
var MenuController = /** @class */ (function() {
   ...
   * @internal
   */
  class_1.prototype._getInstance = function() {
    return Promise.resolve(this);
  };
  class_1.prototype._register = function(menu) {
  ...
  class_1.prototype._unregister = function(menu) {
    var index = this.menus.indexOf(menu);
    if (index > -1) {
      this.menus.splice(index, 1);
    }
  };
  class_1.prototype._setActiveMenu = function(menu) {
  ...
  class_1.prototype._setOpen = function(menu, shouldOpen, animated) {
    return __awaiter(this, void 0, void 0, function() {
      var openedMenu;
      return __generator(this, function(_a) {
        switch (_a.label) {
          ...
          case 2:
            ...
            _a.label = 3;
          case 3:
            return [2 /*return*/, menu._setOpen(shouldOpen, animated)];
        }
      });
    });
  };
  class_1.prototype._createAnimation = function(type, menuCmp) {
    return __awaiter(this, void 0, void 0, function() {
      ...
      return __generator(this, function(_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              import("./index-d3aa5dba.js").then(function(mod) {
  ...
  class_1.prototype.getOpenSync = function() {
    return this.find(function(m) {
      return m._isOpen;
    });
  };
  class_1.prototype.getMenusSync = function() {
    return this.menus.map(function(menu) {
      return menu.el;
    });
  };
  class_1.prototype.isAnimatingSync = function() {
    return this.menus.some(function(menu) {
      return menu.isAnimating;
    });
  };
  class_1.prototype.find = function(predicate) {
  ...
  class_1.prototype.waitUntilReady = function() {
    return Promise.all(
      Array.from(document.querySelectorAll("ion-menu")).map(function(menu) {
