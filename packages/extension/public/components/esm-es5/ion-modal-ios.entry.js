...
} from "./framework-delegate-8aba239f.js";
import { d as deepReady } from "./index-1741adbf.js";
/**
...
var iosLeaveAnimation = function(AnimationC, baseEl) {
  ...
  wrapperAnimation
    ...
    .fromTo(
      "translateY",
      "0%",
      baseEl.ownerDocument.defaultView.innerHeight - wrapperElRect.top + "px"
    );
...
var Modal = /** @class */ (function() {
      ...
      return __generator(this, function(_b) {
        switch (_b.label) {
          ...
          case 2:
            ...
            return [
              2 /*return*/,
              present(this, "modalEnter", iosEnterAnimation, mdEnterAnimation)
            ];
        }
      });
    });
  ...
  class_1.prototype.render = function() {
    ...
    return h(
      ...
      h("div", {
        role: "dialog",
        class: ((_b = {}), (_b["modal-wrapper"] = true), (_b[mode] = true), _b)
      })
    );
  };
