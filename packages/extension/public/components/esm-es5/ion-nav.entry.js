...
import { b as assert } from "./helpers-18f3dc7c.js";
import { a as attachComponent } from "./framework-delegate-8aba239f.js";
import {
  l as lifecycle,
  t as transition,
  s as setPageHidden,
  L as LIFECYCLE_WILL_UNLOAD,
  a as LIFECYCLE_WILL_LEAVE,
  b as LIFECYCLE_DID_LEAVE
} from "./index-1741adbf.js";
...
var Nav = /** @class */ (function() {
  ...
  class_1.prototype.componentWillLoad = function() {
    this.useRouter =
      !!document.querySelector("ion-router") && !this.el.closest("[no-router]");
      ...
      return __generator(this, function(_b) {
        switch (_b.label) {
          case 0:
            this.rootChanged();
            _a = this;
            return [4 /*yield*/, import("./swipe-back-b8b34401.js")];
          case 1:
            _a.gesture = _b
              .sent()
   ...
   * @param done The transition complete function.
   */
  class_1.prototype.insert = function(
    insertIndex,
    component,
    componentProps,
    opts,
   ...
   * @param done The transition complete function.
   */
  class_1.prototype.insertPages = function(
    insertIndex,
    insertComponents,
    opts,
    done
   ...
   * @param done The transition complete function.
   */
  class_1.prototype.removeIndex = function(
    startIndex,
    removeCount,
    opts,
    done
  ...
  class_1.prototype.setRouteId = function(id, params, direction) {
    ...
    if (direction === "root") {
      ...
      if (viewController) {
        finish = this.popTo(
          viewController,
          Object.assign({}, commonOpts, { direction: "back" })
        );
        ...
        finish = this.setRoot(
          id,
          params,
          Object.assign({}, commonOpts, { direction: "back", animated: true })
        );
      }
    }
    return promise;
  ...
  class_1.prototype.prepareTI = function(ti) {
    ...
    for (
      var _i = 0, viewControllers_1 = viewControllers;
      _i < viewControllers_1.length;
      _i++
    ) {
  ...
  class_1.prototype.postViewInit = function(enteringView, leavingView, ti) {
    ...
    if (insertViews) {
      ...
      for (
        var _i = 0, insertViews_1 = insertViews;
        _i < insertViews_1.length;
        _i++
      ) {
    ...
    if (destroyQueue && destroyQueue.length > 0) {
      for (
        var _a = 0, destroyQueue_1 = destroyQueue;
        _a < destroyQueue_1.length;
        _a++
      ) {
      ...
      for (
        var _b = 0, destroyQueue_2 = destroyQueue;
        _b < destroyQueue_2.length;
        _b++
      ) {
  ...
  class_1.prototype.transitionFinish = function(
    hasCompleted,
    enteringView,
    leavingView,
    opts
