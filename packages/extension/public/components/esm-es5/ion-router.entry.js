...
import { e as debounce } from "./helpers-18f3dc7c.js";
    ...
    return __generator(this, function(_a) {
      switch (_a.label) {
        ...
        case 4:
          return [3 /*break*/, 1];
        case 5:
          return [2 /*return*/, { ids: ids, outlet: outlet }];
      }
    });
  });
};
...
var Router = /** @class */ (function() {
  ...
  class_1.prototype.safeWriteNavState = function(
    node,
    chain,
    direction,
    path,
  ...
  class_1.prototype.writeNavState = function(
    node,
    chain,
    direction,
    path,
  ...
  class_1.prototype.routeChangeEvent = function(path, redirectFromPath) {
    ...
    var redirectedFrom = redirectFromPath
