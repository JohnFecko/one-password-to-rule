...
import {
  f as popoverController,
  h as actionSheetController,
  j as alertController
  ...
  class_1.prototype.openPopover = function(ev) {
    return __awaiter(this, void 0, void 0, function() {
      ...
      return __generator(this, function(_a) {
        ...
        popoverOpts = Object.assign({ mode: mode }, interfaceOptions, {
  ...
  class_1.prototype.openActionSheet = function() {
    return __awaiter(this, void 0, void 0, function() {
      ...
      return __generator(this, function(_a) {
        mode = getIonMode(this);
        interfaceOptions = this.interfaceOptions;
        actionSheetOpts = Object.assign({ mode: mode }, interfaceOptions, {
  ...
  class_1.prototype.openAlert = function() {
    return __awaiter(this, void 0, void 0, function() {
      ...
      return __generator(this, function(_a) {
        ...
        mode = getIonMode(this);
        alertOpts = Object.assign({ mode: mode }, interfaceOptions, {
        ...
        switch (_b.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              Promise.all(
                Array.from(this.el.querySelectorAll("ion-select-option")).map(
                  function(o) {
