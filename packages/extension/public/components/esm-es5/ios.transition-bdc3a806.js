...
var iosTransitionAnimation = function(AnimationC, navEl, opts) {
  ...
  var headerEls = enteringEl.querySelectorAll(
    ":scope > ion-header > *:not(ion-toolbar), :scope > ion-footer > *"
  );
  var enteringToolBarEls = enteringEl.querySelectorAll(
  ...
  if (backDirection) {
    ...
    if (contentEl) {
      var enteringTransitionEffectEl = shadow(contentEl).querySelector(
        ".transition-effect"
      );
      if (enteringTransitionEffectEl) {
        var enteringTransitionCoverEl = enteringTransitionEffectEl.querySelector(
          ".transition-cover"
        );
        var enteringTransitionShadowEl = enteringTransitionEffectEl.querySelector(
          ".transition-shadow"
        );
  ...
  if (leavingEl) {
    ...
    if (backDirection) {
      ...
      if (leavingContentEl) {
        var leavingTransitionEffectEl = shadow(leavingContentEl).querySelector(
          ".transition-effect"
        );
        if (leavingTransitionEffectEl) {
          var leavingTransitionCoverEl = leavingTransitionEffectEl.querySelector(
            ".transition-cover"
          );
          var leavingTransitionShadowEl = leavingTransitionEffectEl.querySelector(
            ".transition-shadow"
          );
    ...
    var leavingToolBarEls = leavingEl.querySelectorAll(
      ":scope > ion-header > ion-toolbar"
    );
    leavingToolBarEls.forEach(function(leavingToolBarEl) {
      ...
      var leavingToolBarItemEls = leavingToolBarEl.querySelectorAll(
        ":scope > *:not(ion-title):not(ion-buttons):not([menuToggle])"
      );
