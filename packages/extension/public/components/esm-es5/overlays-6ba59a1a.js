...
var _this = this;
import { c as config } from "./core-9991b89e.js";
var lastId = 0;
  ...
  if (lastId === 0) {
    ...
    doc.addEventListener("focusin", function(ev) {
      ...
      if (
        ...
        !isDescendant(lastOverlay, ev.target)
      ) {
...
var getOverlays = function(doc, overlayTag) {
  var overlays = Array.from(getAppRoot(doc).children).filter(function(c) {
  ...
  return overlays.filter(function(c) {
    return c.tagName === overlayTag;
  });
};
      ...
      switch (_a.label) {
        case 0:
          ...
          animationBuilder = overlay.enterAnimation
            ...
            : config.get(
                name,
                overlay.mode === "ios" ? iosEnterAnimation : mdEnterAnimation
              );
          return [
            4 /*yield*/,
      ...
      switch (_a.label) {
        ...
        case 1:
          ...
          animationBuilder = overlay.leaveAnimation
            ...
            : config.get(
                name,
                overlay.mode === "ios" ? iosLeaveAnimation : mdLeaveAnimation
              );
          return [
            4 /*yield*/,
            overlayAnimation(overlay, animationBuilder, overlay.el, opts)
...
export {
  BACKDROP as B,
  dismiss as a,
  pickerController as b,
  createOverlay as c,
  dismissOverlay as d,
  eventMethod as e,
  popoverController as f,
  getOverlay as g,
  actionSheetController as h,
  isCancel as i,
  alertController as j,
  present as p,
  safeCall as s
};
