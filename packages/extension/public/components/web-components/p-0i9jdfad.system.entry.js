      ...
      execute: function() {
          ...
          (function() {
            function t(t) {
              ...
              this.handleKeyboard = function(t, n) {
                ...
                if (t === "A") {
                  e.ratioA = u(0, e.ratioA + i, 1);
                } else {
                  e.ratioB = u(0, e.ratioB + i, 1);
                }
                e.updateValue();
              };
            ...
            t.prototype.update = function(t) {
              var e = this.rect;
              var n = u(0, (t - e.left) / e.width, 1);
              if (document.dir === "rtl") {
                n = 1 - n;
              }
              if (this.snaps) {
                n = v(b(n, this.min, this.max, this.step), this.min, this.max);
              }
            ...
            t.prototype.updateRatio = function() {
              ...
              var e = this,
                ...
                i = e.max;
              if (this.dualKnobs) {
                this.ratioA = v(t.lower, n, i);
                this.ratioB = v(t.upper, n, i);
              } else {
                this.ratioA = v(t, n, i);
              }
            };
            ...
            t.prototype.render = function() {
              ...
              var F = ((t = {}), (t[C] = x), (t[_] = k), t);
              var P = [];
              if (this.snaps && this.ticks) {
                for (var M = s; M <= u; M += h) {
                  var O = v(M, s, u);
                  var R = { ratio: O, active: O >= w && O <= B };
                  R[C] = O * 100 + "%";
                  P.push(R);
                }
              }
              l(true, p, this.name, JSON.stringify(this.getValue()), m);
              return a(
                o,
                {
                  ...
                  class: Object.assign(
                    ...
                    ((e = {}),
                    (e[A] = true),
                    (e["in-item"] = d("ion-item", p)),
                    (e["range-disabled"] = m),
                    (e["range-pressed"] = g !== undefined),
                    (e["range-has-pin"] = y),
                    e)
                  )
                },
                ...
                a(
                  ...
                  a("div", { class: "range-bar", role: "presentation" }),
                  a("div", {
        ...
        var f = function(t, e) {
          ...
          return a(
            ...
            a("div", { class: "range-knob", role: "presentation" })
          );
        };
        var b = function(t, e, n, i) {
          var r = (n - e) * t;
          if (i > 0) {
            r = Math.round(r / i) * i + e;
          }
          return u(e, r, n);
        };
        var v = function(t, e, n) {
          return u(0, (t - e) / (n - e), 1);
        };
      }
    };
  }
