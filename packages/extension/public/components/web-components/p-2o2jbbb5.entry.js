import { r as t, c as s, e, h as i, H as a, f as n } from "./p-57e9347d.js";
import { h as r } from "./p-955ba954.js";
const o = class {
  constructor(s) {
    t(this, s), (this.animated = !1);
  }
  calculateWidth() {
    if (void 0 !== this.width) return { style: { width: this.width } };
  }
  render() {
    const t = this.animated && s.getBoolean("animated", !0),
      n = r("ion-avatar", this.el) || r("ion-thumbnail", this.el),
      o = e(this);
    return i(
      a,
      Object.assign(
        { class: { [o]: !0, "skeleton-text-animated": t, "in-media": n } },
        this.calculateWidth()
      ),
      i("span", null, " ")
    );
