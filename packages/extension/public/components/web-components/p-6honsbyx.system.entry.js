    ...
    execute: function() {
      ...
      var p = function(t, e, r, i) {
        ...
        var v = function(r) {
          ...
          if (i) {
            ...
            t.push({ d: false, cell: r, visible: true, change: f, top: e[n] });
          }
        };
      ...
      var v = function(t, e, r, i) {
        ...
        for (var a = 0; a < r.length; a++) {
          ...
          if (l.change !== u) {
            s.style.transform = "translate3d(0," + l.top + "px,0)";
          }
          var d = h.visible;
          if (l.visible !== d) {
            if (d) {
              s.classList.remove("virtual-loading");
            } else {
              s.classList.add("virtual-loading");
            }
            l.visible = d;
          }
          if (h.reads > 0) {
      ...
      var g = function(t, e) {
        var r = m(t, e);
        if (r && t.ownerDocument) {
          return t.ownerDocument.importNode(r.content, true).children[0];
        }
        return null;
      };
      var m = function(t, e) {
      ...
      var y = function(t, e, r) {
        return { top: Math.max(t - r, 0), bottom: t + e + r };
      };
      var b = function(t, e, r) {
        ...
        var s = Math.max(o - r - 1, 0);
        for (; o < t.length; o++) {
          if (t[o] >= n) {
            break;
          }
        }
        var a = Math.min(o + r, t.length);
        var l = a - s;
        return { offset: s, length: l };
      };
      var x = function(t, e, r) {
        var i = r.offset + r.length;
        return t <= i || e.offset !== r.offset || e.length !== r.length;
      };
      var H = function(t, e) {
        var r = t.length > 0 ? t[t.length - 1].index : 0;
        if (e === 0) {
          return 0;
        } else if (e === r + 1) {
          return t.length;
      ...
      var E = function(t, e, r, i, n, o, s, u, c, f, p, v) {
        var g = [];
        var m = v + p;
        for (var y = p; y < m; y++) {
          var b = t[y];
      ...
      var D = t(
        ...
        (function() {
              ...
              return __generator(this, function(r) {
                switch (r.label) {
                  case 0:
                    ...
                    if (!t) {
                      console.error(
                        "virtual-scroll must be used inside ion-content"
                      );
                      return [2];
                    }
          ...
          t.prototype.positionForItem = function(t) {
            return Promise.resolve(_(t, this.cells, this.getHeightIndex()));
          };
          ...
          t.prototype.readVS = function() {
            ...
            if (r) {
              this.viewportHeight = r.offsetHeight;
              this.currentScrollTop = r.scrollTop;
            }
          };
          t.prototype.writeVS = function() {
            var t = this.indexDirty;
            var e = this.currentScrollTop - this.viewportOffset;
            var r = y(e, this.viewportHeight, 100);
            var i = this.getHeightIndex();
            var n = b(i, r, 2);
            var o = x(t, this.range, n);
            if (!o) {
              return;
            }
            this.range = n;
            p(this.virtualDom, i, this.cells, n);
            if (this.nodeRender) {
              v(
                this.el,
                this.nodeRender,
          ...
          t.prototype.calcHeightIndex = function(t) {
            ...
            this.heightIndex = I(this.heightIndex, this.cells.length);
            this.totalHeight = S(this.heightIndex, this.cells, t);
          ...
          t.prototype.enableScrollEvents = function(t) {
            ...
            if (r) {
              ...
              this.rmEvent = function() {
                r.removeEventListener("scroll", e.onScroll);
              };
            }
          };
          t.prototype.renderVirtualNode = function(t) {
            ...
            switch (r) {
              case a:
                return this.renderItem(i, n);
              case l:
                return this.renderHeader(i, n);
              case h:
                return this.renderFooter(i, n);
            }
          };
