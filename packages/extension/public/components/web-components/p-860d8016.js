...
(function() {
      ...
      (o(
        ...
        function(n) {
          if ("link" === n.localName && "import" === n.getAttribute("rel")) {
            var i = n.import;
            i instanceof Node &&
              ((i.__CE_isImportDocument = !0), (i.__CE_hasRegistry = !0)),
  ...
  function l(t, n) {
    if (void 0 === n.__CE_state) {
      ...
      if (
        (e.defaultView || (e.__CE_isImportDocument && e.__CE_hasRegistry)) &&
        (e = t.a.get(n.localName))
      ) {
  ...
  (f.prototype.connectedCallback = function(t) {
    ...
    (f.prototype.attributeChangedCallback = function(t, n, i, e, o) {
      ...
      r.attributeChangedCallback &&
        -1 < r.observedAttributes.indexOf(n) &&
        r.attributeChangedCallback.call(t, n, i, e, o);
    }),
    (d.prototype.f = function(t) {
      var n = this.a.readyState;
      for (
        ("interactive" !== n && "complete" !== n) || w(this), n = 0;
        n < t.length;
        n++
      )
    ...
    (b.prototype.define = b.prototype.l),
    (b.prototype.upgrade = b.prototype.i),
  ...
  var E = window.Document.prototype.createElement,
    ...
    A = window.Node.prototype.appendChild,
    D = window.Node.prototype.insertBefore,
    ...
    function o(n) {
      return function(e) {
        ...
        for (var f = [], s = 0; s < o.length; s++) {
          var u = o[s];
          if (
            (u instanceof Element && i(u) && f.push(u),
        ...
        if (i(this))
          for (o = 0; o < r.length; o++)
            (f = r[o]) instanceof Element && c(t, f);
      };
    }
    void 0 !== e.h && (n.prepend = o(e.h)),
      void 0 !== e.append && (n.append = o(e.append));
  }
  var Z,
    ...
    (Z = nt),
      (window.HTMLElement = (function() {
        function t() {
          ...
          return (i[n] = X), Object.setPrototypeOf(e, t.prototype), u(Z, e), e;
        }
        return (
      ...
      (function() {
        ...
        r(Document.prototype, "createElement", function(n) {
          ...
          r(Document.prototype, "importNode", function(n, i) {
            return (
              (n = g.call(this, n, !!i)),
              this.__CE_hasRegistry ? h(t, n) : s(t, n),
              n
            );
          }),
          ...
          Y(t, Document.prototype, { h: y, append: C });
      })(),
      Y(nt, DocumentFragment.prototype, { h: T, append: j }),
      (function() {
        function t(t, e) {
        ...
        r(Node.prototype, "insertBefore", function(t, e) {
          if (t instanceof DocumentFragment) {
            ...
            if (((t = D.call(this, t, e)), i(this)))
              for (e = 0; e < o.length; e++) c(n, o[e]);
            return t;
          }
          return (
            (o = i(t)),
          ...
          r(Node.prototype, "appendChild", function(t) {
            if (t instanceof DocumentFragment) {
              ...
              if (((t = A.call(this, t)), i(this)))
                for (var o = 0; o < e.length; o++) c(n, e[o]);
              return t;
            }
            return (
              (e = i(t)),
          ...
          r(Node.prototype, "cloneNode", function(t) {
            return (
              (t = N.call(this, !!t)),
              this.ownerDocument.__CE_hasRegistry ? h(n, t) : s(n, t),
              t
            );
          }),
          ...
          r(Node.prototype, "replaceChild", function(t, e) {
            if (t instanceof DocumentFragment) {
              var o = Array.prototype.slice.apply(t.childNodes);
              if (((t = O.call(this, t, e)), i(this)))
                for (a(n, e), e = 0; e < o.length; e++) c(n, o[e]);
              return t;
            }
            o = i(t);
            var r = O.call(this, t, e),
              f = i(this);
            return f && a(n, e), o && a(n, t), f && c(n, t), r;
          }),
          S && S.get
            ? t(Node.prototype, S)
            : (function(t, n) {
                ...
                t(n, {
                  ...
                  set: function(t) {
                    ...
                    null != t &&
                      "" !== t &&
                      A.call(this, document.createTextNode(t));
                  }
                });
              });
      })(),
      (function() {
            ...
            set: function(t) {
              ...
              if (
                ...
                for (var u = 0; u < r.length; u++) {
                  var c = r[u];
                  1 === c.__CE_state && f.disconnectedCallback(c);
                }
              return (
                this.ownerDocument.__CE_hasRegistry ? h(f, this) : s(f, this), t
              );
            }
          });
        }
        function n(t, n) {
          r(t, "insertAdjacentElement", function(t, e) {
            var o = i(e);
            return (t = n.call(this, t, e)), o && a(f, e), i(t) && c(f, e), t;
          });
        }
        function e(t, n) {
          function i(t, n) {
          ...
          r(t, "insertAdjacentHTML", function(t, e) {
            if ("beforebegin" === (t = t.toLowerCase())) {
              ...
              (o = this.firstChild), n.call(this, t, e), i(this.firstChild, o);
            else if ("beforeend" === t)
              (o = this.lastChild),
                n.call(this, t, e),
                i(o || this.firstChild, null);
            else {
              if ("afterend" !== t)
        ...
        k &&
            ...
            : (function(t, n) {
                ...
                t(n, {
                  ...
                  set: function(t) {
                    ...
                    for (e.innerHTML = t; 0 < i.childNodes.length; )
                      M.call(i, i.childNodes[0]);
                    for (t = n ? e.content : e; 0 < t.childNodes.length; )
                      A.call(i, t.childNodes[0]);
                  }
                });
              }),
          r(Element.prototype, "setAttribute", function(t, n) {
            ...
            H.call(this, t, n),
              (n = F.call(this, t)),
              f.attributeChangedCallback(this, t, i, n, null);
          }),
          r(Element.prototype, "setAttributeNS", function(t, n, i) {
            ...
            P.call(this, t, n, i),
              (i = z.call(this, t, n)),
              f.attributeChangedCallback(this, n, e, i, t);
          }),
          r(Element.prototype, "removeAttribute", function(t) {
            if (1 !== this.__CE_state) return x.call(this, t);
            var n = F.call(this, t);
            x.call(this, t),
              null !== n && f.attributeChangedCallback(this, t, n, null, null);
          }),
          ...
          V
            ? e(HTMLElement.prototype, V)
            : _
            ? e(Element.prototype, _)
            : console.warn(
                "Custom Elements: `Element#insertAdjacentHTML` was not patched."
              ),
          Y(f, Element.prototype, { h: B, append: I }),
          (function(t) {
            function n(n) {
              return function(e) {
            ...
            void 0 !== U && (e.before = n(U)),
              void 0 !== U && (e.after = n(W)),
              void 0 !== q &&
                r(e, "replaceWith", function(n) {
                  ...
                  for (var r = [], f = 0; f < e.length; f++) {
                    var s = e[f];
                    if (
                      (s instanceof Element && i(s) && r.push(s),
                      s instanceof DocumentFragment)
                    )
                      for (s = s.firstChild; s; s = s.nextSibling) o.push(s);
                    else o.push(s);
                  }
                  for (f = i(this), q.apply(this, e), e = 0; e < r.length; e++)
                    a(t, r[e]);
                  if (f)
                    for (a(t, this), e = 0; e < o.length; e++)
                      (r = o[e]) instanceof Element && c(t, r);
                }),
              void 0 !== G &&
                r(e, "remove", function() {
                  var n = i(this);
  ...
  "string" != typeof document.baseURI &&
    Object.defineProperty(Document.prototype, "baseURI", {
      ...
      get: function() {
        ...
        return t ? t.href : document.URL;
      }
    }),
  "function" != typeof window.CustomEvent &&
    ((window.CustomEvent = function(t, n) {
  ...
  (function(t) {
    function n(t) {
      return t.parentNode ? n(t.parentNode) : t;
    }
    "function" != typeof t.getRootNode &&
      (t.getRootNode = function(t) {
        return t && t.composed
          ? (function t(i) {
              return 11 === (i = n(i)).nodeType ? t(i.host) : i;
            })(this)
          : n(this);
      });
  })(Element.prototype),
    ...
    Object.defineProperty(o, "classList", {
      get: function() {
        ...
        return (
          ...
          (n.add = function() {
            for (
              var t = [].slice.call(arguments), e = 0, o = t.length;
              e < o;
              e++
            )
          ...
          (n.remove = function() {
            for (
              ...
              -1 !== n.indexOf(t[e]) && n.splice(n.indexOf(t[e]), 1);
            i();
          }),
          (n.item = function(t) {
            return n[t];
