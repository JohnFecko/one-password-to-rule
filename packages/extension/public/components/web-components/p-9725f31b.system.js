    ...
    execute: function() {
      (function() {
          ...
          if (void 0 === e.__CE_state) {
            ...
            if (
              ...
              if ((o = t.a.get(e.localName))) {
                ...
                e.__CE_state = 1;
                e.__CE_definition = o;
                if (o.attributeChangedCallback)
                  for (o = o.observedAttributes, i = 0; i < o.length; i++) {
                    var r = o[i],
                      a = e.getAttribute(r);
                    null !== a &&
                      t.attributeChangedCallback(e, r, null, a, null);
                  }
        ...
        b.prototype.f = function(t) {
          ...
          ("interactive" !== e && "complete" !== e) || y(this);
        ...
        var _ = window.Document.prototype.createElement,
          ...
          D = window.Document.prototype.append,
            ...
            return function(o) {
              ...
              if (n(this))
                for (i = 0; i < r.length; i++)
                  (a = r[i]), a instanceof Element && p(t, a);
            };
          }
        ...
        function it() {
          ...
          ot(t, Document.prototype, { h: S, append: D });
        }
        function rt() {
          function t(t, o) {
        ...
        function at(t) {
          ...
          void 0 !== J &&
            r(o, "replaceWith", function(e) {
              ...
              if (a)
                for (h(t, this), o = 0; o < i.length; o++)
                  (r = i[o]), r instanceof Element && p(t, r);
            });
          void 0 !== K &&
            r(o, "remove", function() {
              var e = n(this);
        ...
        function ct() {
          ...
          R && R.get
            ? t(Element.prototype, R)
            : Y && Y.get
            ? t(HTMLElement.prototype, Y)
            : s(a, function(e) {
                t(e, {
                  enumerable: !0,
                  configurable: !0,
        ...
        if (
          ...
          nt();
          it();
          ot(st, DocumentFragment.prototype, { h: T, append: A });
          rt();
          ct();
      ...
      if (typeof window.CustomEvent !== "function") {
        window.CustomEvent = function t(e, n) {
          n = n || { bubbles: false, cancelable: false, detail: undefined };
      ...
      (function(t) {
        function e(t) {
          t = n(t);
          return 11 === t.nodeType ? e(t.host) : t;
        }
        function n(t) {
