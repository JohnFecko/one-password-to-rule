...
System.register(["./p-83e6ea9f.system.js", "./p-95d7e664.system.js"], function(
  t,
  e
) {
  "use strict";
  var r, n, i, o, s, l, a, c, u;
  return {
    setters: [
      function(t) {
        r = t.r;
        ...
        (function() {
            ...
            return __awaiter(this, void 0, void 0, function() {
              ...
              return __generator(this, function(o) {
                switch (o.label) {
                  ...
                  case 3:
                    n.gesture = o.sent().createGesture({
                      el: this.el,
                      gestureName: "reorder",
                      gesturePriority: 110,
                      threshold: 0,
          ...
          t.prototype.onStart = function(t) {
            ...
            if (this.scrollEl) {
              ...
              this.scrollElTop = u.top + p;
              this.scrollElBottom = u.bottom - p;
            } else {
              this.scrollElInitial = 0;
              this.scrollElTop = 0;
              this.scrollElBottom = 0;
            }
            this.lastToIndex = f(e);
          ...
          t.prototype.onMove = function(t) {
            ...
            var n = this.containerTop - r;
            var i = this.containerBottom - r;
            var o = Math.max(n, Math.min(t.currentY, i));
            var s = r + o - t.startY;
            var l = o - n;
            var a = this.itemIndexForTop(l);
            if (a !== this.lastToIndex) {
              var u = f(e);
              this.lastToIndex = a;
              c();
              this.reorderMove(u, a);
            }
          ...
          t.prototype.onEnd = function() {
            ...
            var r = this.lastToIndex;
            var n = f(e);
            if (r === n) {
              e.style.transition = "transform 200ms ease-in-out";
              e.style.transform = "";
              e.classList.remove(m);
              setTimeout(function() {
                return t.completeSync();
              }, 200);
            } else {
          ...
          t.prototype.render = function() {
            ...
            return o(l, {
              class:
                ...
                (t["reorder-list-active"] = this.state !== 0),
                t)
            });
          };
