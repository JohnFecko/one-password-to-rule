      ...
      while (n)
        try {
          ...
          switch (i[0]) {
            ...
            default:
              if (
                !((u = n.trys), (u = u.length > 0 && u[u.length - 1])) &&
                (i[0] === 6 || i[0] === 2)
              ) {
                n = 0;
                continue;
      ...
      var s = t(
        ...
        (function() {
            ...
            this.onClick = function(t) {
              return __awaiter(r, void 0, void 0, function() {
                ...
                return __generator(this, function(r) {
                  switch (r.label) {
                    case 0:
                      e = this.el.closest("ion-nav");
                      t.preventDefault();
                      n = e;
                      if (!n) return [3, 2];
                      return [4, e.canGoBack()];
                    case 1:
                      n = r.sent();
                      r.label = 2;
                    case 2:
                      if (n) {
                        return [2, e.pop({ skipIfBusy: true })];
                      }
                      return [2, a(this.defaultHref, t, "back")];
                  }
                });
              });
            };
          ...
          Object.defineProperty(t.prototype, "backButtonIcon", {
            get: function() {
              return this.icon != null
                ? this.icon
                : r.get("backButtonIcon", "arrow-back");
            },
            enumerable: true,
            configurable: true
          });
          Object.defineProperty(t.prototype, "backButtonText", {
            get: function() {
              var t = this.mode === "ios" ? "Back" : null;
              return this.text != null ? this.text : r.get("backButtonText", t);
            },
            enumerable: true,
            configurable: true
          });
            ...
            return o(
              u,
              {
                ...
                class: Object.assign(
                  ...
                  (t[s] = true),
                  (t["button"] = true),
                  (t["back-button-disabled"] = i),
                  (t["back-button-has-icon-only"] = l),
                  (t["ion-activatable"] = true),
                  (t["ion-focusable"] = true),
              ...
              o(
                "button",
                { type: a, disabled: i, class: "button-native" },
                o(
                  "span",
                  { class: "button-inner" },
                  f && o("ion-icon", { icon: f, lazy: false }),
                  b && o("span", { class: "button-text" }, b)
                ),
                s === "md" && o("ion-ripple-effect", { type: this.rippleType })
              )
            );
          };
