    ...
    return {
      ...
      execute: function() {
        var p = function(e, t) {
          ...
          var i = new e();
          i.addElement(t.querySelector(".action-sheet-wrapper"));
          r.fromTo("opacity", 0.01, 0.4);
          i.fromTo("translateY", "100%", "0%");
          var o = n
            .addElement(t)
          ...
          (function() {
            function e(e) {
              ...
              this.onBackdropTap = function() {
                i.dismiss(undefined, s);
              };
              this.dispatchCancelHandler = function(e) {
                var t = e.detail.role;
                if (c(t)) {
                  var n = i.getButtons().find(function(e) {
                    return e.role === "cancel";
                  });
                  i.callButtonHandler(n);
                }
              };
              this.didPresent = r(this, "ionActionSheetDidPresent", 7);
              this.willPresent = r(this, "ionActionSheetWillPresent", 7);
              this.willDismiss = r(this, "ionActionSheetWillDismiss", 7);
              this.didDismiss = r(this, "ionActionSheetDidDismiss", 7);
            }
            e.prototype.present = function() {
              return u(this, "actionSheetEnter", p, b);
            };
            e.prototype.dismiss = function(e, t) {
              return l(this, e, t, "actionSheetLeave", v, m);
            };
            e.prototype.onDidDismiss = function() {
              return d(this.el, "ionActionSheetDidDismiss");
            };
            e.prototype.onWillDismiss = function() {
              return d(this.el, "ionActionSheetWillDismiss");
            };
                ...
                return __generator(this, function(r) {
                  switch (r.label) {
                    ...
                    case 1:
                      n = r.sent();
                      if (n) {
                        return [2, this.dismiss(undefined, e.role)];
                      }
        ...
        var w = function(e) {
          ...
          return Object.assign(
            ((t = { "action-sheet-button": true, "ion-activatable": true }),
            (t["action-sheet-" + e.role] = e.role !== undefined),
            t),
            f(e.cssClass)
          );
        };
