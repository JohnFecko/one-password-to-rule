    ...
    execute: function() {
      var u = {
        lines: {
          ...
          lines: 12,
          fn: function(e, r, t) {
            var n = "rotate(" + (30 * r + (r < 6 ? 180 : -180)) + "deg)";
            var s = (e * r) / t - e + "ms";
            return {
              y1: 17,
              y2: 29,
              style: { transform: n, "animation-delay": s }
            };
          }
        },
        "lines-small": {
        ...
        dots: {
          ...
          fn: function(e, r) {
            ...
            return {
              r: 6,
              style: { left: 9 - 9 * r + "px", "animation-delay": t }
            };
          }
        }
      };
      ...
      var l = e(
        ...
        (function() {
          ...
          e.prototype.getName = function() {
            var e = this.name || t.get("spinner");
            var r = n(this);
            if (e) {
              return e;
            }
            return r === "ios" ? "lines" : "crescent";
          };
          e.prototype.render = function() {
            ...
            var l = o[u] || o["lines"];
            var y =
              typeof this.duration === "number" && this.duration > 10
                ? this.duration
                : l.dur;
            var v = [];
            if (l.circles !== undefined) {
              for (var d = 0; d < l.circles; d++) {
                v.push(c(l, y, d, l.circles));
              }
            } else if (l.lines !== undefined) {
              for (var d = 0; d < l.lines; d++) {
                v.push(f(l, y, d, l.lines));
              }
            }
            return s(
              i,
              {
                class: Object.assign(
                  ...
                  (e["spinner-" + u] = true),
                  (e["spinner-paused"] =
                    !!this.paused || t.getBoolean("_testing")),
                  e)
                )
              },
              v
      ...
      var c = function(e, r, t, n) {
        ...
        return s(
          ...
          s("circle", { transform: "translate(32,32)", r: i.r })
        );
      };
      var f = function(e, r, t, n) {
        ...
        return s(
          "svg",
          { viewBox: "0 0 64 64", style: i.style },
          s("line", { transform: "translate(32,32)", y1: i.y1, y2: i.y2 })
        );
      };
    }
  };
