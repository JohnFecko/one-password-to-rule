...
import { d as o, f as r } from "./p-18f3dc7c.js";
import { c as l } from "./p-955ba954.js";
const u = class {
  constructor(i) {
    t(this, i),
      ...
      (this.ionInput = s(this, "ionInput", 7)),
      (this.ionStyle = s(this, "ionStyle", 7)),
      (this.ionBlur = s(this, "ionBlur", 7)),
      (this.ionFocus = s(this, "ionFocus", 7)),
      (this.ionInputDidLoad = s(this, "ionInputDidLoad", 7)),
      (this.ionInputDidUnload = s(this, "ionInputDidUnload", 7));
  }
  debounceChanged() {
  ...
  valueChanged() {
    ...
    t && t.value !== s && (t.value = s),
      this.runAutoGrow(),
      this.emitStyle(),
      this.ionChange.emit({ value: s });
  }
  componentWillLoad() {
    this.emitStyle();
  }
  componentDidLoad() {
    this.debounceChanged(), this.runAutoGrow(), this.ionInputDidLoad.emit();
  }
  runAutoGrow() {
    const t = this.nativeInput;
    t &&
      this.autoGrow &&
      i(() => {
        (t.style.height = "inherit"), (t.style.height = t.scrollHeight + "px");
      });
  }
  componentDidUnload() {
    ...
    return (
      ...
      e(
        a,
        {
          ...
          class: Object.assign({}, l(this.color), { [t]: !0 })
        },
        e(
          "textarea",
          {
