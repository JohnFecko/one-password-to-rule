import { r as t, e as s, h as i, H as a, f as e } from "./p-57e9347d.js";
const o = class {
  constructor(s) {
    t(this, s),
      (this.edge = !1),
      ...
      (this.onClick = () => {
        const t = !!this.el.querySelector("ion-fab-list"),
          s = this.getFab();
        t && (!s || !s.disabled) && (this.activated = !this.activated);
      });
  }
  activatedChanged() {
    const t = this.activated,
      s = this.getFab();
    s && (s.activated = t),
      Array.from(this.el.querySelectorAll("ion-fab-list")).forEach(s => {
        s.activated = t;
      });
  }
  componentDidLoad() {
  ...
  render() {
    const { horizontal: t, vertical: e, edge: o } = this,
      n = s(this);
    return i(
      a,
      {
