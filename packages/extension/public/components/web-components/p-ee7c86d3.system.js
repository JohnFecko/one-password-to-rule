System.register(["./p-0958cff4.system.js"], function(e) {
  ...
  return {
    ...
    execute: function() {
      var r = e("startTapClick", function(e) {
        var r = -f * 10;
        var v = 0;
        var d;
        var l;
        ...
        var m;
        var L =
          e.getBoolean("animated", true) && e.getBoolean("rippleEffect", true);
        var E = new WeakMap();
        var h = function() {
          return d !== undefined && d.parentElement !== null;
        };
        var w = function(e) {
          r = t(e);
          R(e);
        ...
        var C = document;
        C.addEventListener("ionScrollStart", function(e) {
          d = e.target;
          y();
        });
        C.addEventListener("ionScrollEnd", function() {
          d = undefined;
        });
