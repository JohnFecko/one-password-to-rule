        ...
        (function() {
          ...
          t.prototype.render = function() {
            ...
            var n = this,
              ...
              p = n.translucent,
              v = n.size;
            var y = u("ion-fab-list", r);
            var g = i(this);
            var m = b === undefined ? "button" : "a";
            var j =
              m === "button"
                ? { type: this.type }
                : {
            ...
            return s(
              o,
              {
                ...
                class: Object.assign(
                  ...
                  ((t = {}),
                  (t[g] = true),
                  (t["fab-button-in-list"] = y),
                  (t["fab-button-translucent-in-list"] = y && p),
                  (t["fab-button-close-active"] = h),
                  (t["fab-button-show"] = d),
                  (t["fab-button-disabled"] = c),
                  (t["fab-button-translucent"] = p),
                  (t["ion-activatable"] = true),
                  (t["ion-focusable"] = true),
                  (t["fab-button-" + v] = v !== undefined),
                  t)
                )
              },
              s(
                ...
                Object.assign({}, j, {
                  ...
                  onBlur: this.onBlur,
                  onClick: function(t) {
                    return a(b, t, e.routerDirection);
                  }
                }),
                s(
                  "span",
                  { class: "close-icon" },
                  s("ion-icon", { name: "close", lazy: false })
                ),
                s("span", { class: "button-inner" }, s("slot", null)),
                g === "md" && s("ion-ripple-effect", null)
              )
            );
          };
