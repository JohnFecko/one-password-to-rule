...
import { r as o } from "./p-18f3dc7c.js";
const h = class {
  constructor(s) {
    i(this, s),
      (this.didInit = !1),
      ...
      (this.pager = !1),
      (this.scrollbar = !1),
      (this.ionSlidesDidLoad = t(this, "ionSlidesDidLoad", 7)),
      (this.ionSlideTap = t(this, "ionSlideTap", 7)),
      (this.ionSlideDoubleTap = t(this, "ionSlideDoubleTap", 7)),
      (this.ionSlideWillChange = t(this, "ionSlideWillChange", 7)),
      (this.ionSlideDidChange = t(this, "ionSlideDidChange", 7)),
      (this.ionSlideNextStart = t(this, "ionSlideNextStart", 7)),
      (this.ionSlidePrevStart = t(this, "ionSlidePrevStart", 7)),
      (this.ionSlideNextEnd = t(this, "ionSlideNextEnd", 7)),
      (this.ionSlidePrevEnd = t(this, "ionSlidePrevEnd", 7)),
      (this.ionSlideTransitionStart = t(this, "ionSlideTransitionStart", 7)),
      (this.ionSlideTransitionEnd = t(this, "ionSlideTransitionEnd", 7)),
      (this.ionSlideDrag = t(this, "ionSlideDrag", 7)),
      (this.ionSlideReachStart = t(this, "ionSlideReachStart", 7)),
      (this.ionSlideReachEnd = t(this, "ionSlideReachEnd", 7)),
      (this.ionSlideTouchStart = t(this, "ionSlideTouchStart", 7)),
      (this.ionSlideTouchEnd = t(this, "ionSlideTouchEnd", 7));
  }
  ...
  async slideTo(i, t, s) {
    (await this.getSwiper()).slideTo(i, t, s);
  }
  async slideNext(i, t) {
    (await this.getSwiper()).slideNext(i, t);
  }
  async slidePrev(i, t) {
    (await this.getSwiper()).slidePrev(i, t);
  }
  ...
  async lockSwipes(i) {
    ...
    (t.allowSlideNext = !i), (t.allowSlidePrev = !i), (t.allowTouchMove = !i);
  }
  async initSwiper() {
    const i = this.normalizeOptions(),
      { Swiper: t } = await __sc_import_web_components("./p-09e1830f.js"),
      s = new t(this.el, i);
    (this.didInit = !0), this.readySwiper(s);
  }
  getSwiper() {
    return this.swiper;
  }
  normalizeOptions() {
    ...
    return Object.assign({}, i, this.options, t);
  }
  render() {
    const i = s(this);
    return e(
      ...
      e("div", { class: "swiper-wrapper" }, e("slot", null)),
      this.pager &&
        e("div", {
