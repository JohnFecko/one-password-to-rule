import { r as t, e as s, h as o, H as i, f as e } from "./p-57e9347d.js";
...
const a = class {
  ...
  render() {
    const { disabled: t, expandable: e, href: a } = this,
      l = void 0 === a ? "button" : "a",
      r = s(this),
      p =
        "button" === l
    ...
    return o(
      i,
      {
        ...
        class: Object.assign({}, n(this.color), {
          [r]: !0,
      ...
      o(
        l,
        Object.assign({}, p, { class: "button-native", disabled: t }),
        o(
          "span",
          { class: "button-inner" },
          o("slot", { name: "top" }),
          o(
            ...
            o("slot", { name: "start" }),
            o("slot", { name: "icon-only" }),
            o("slot", null),
            o("slot", { name: "end" })
          ),
          o("slot", { name: "bottom" })
        ),
        "md" === r && o("ion-ripple-effect", null)
      )
    );
  }
  get el() {
