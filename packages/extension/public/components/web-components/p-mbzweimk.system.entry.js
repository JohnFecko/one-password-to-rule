      ...
      var l = e(
        ...
        (function() {
          function e(e) {
            ...
            this.ionTabButtonClick = n(this, "ionTabButtonClick", 7);
          }
          e.prototype.onTabBarChanged = function(e) {
            this.selected = this.tab === e.detail.tab;
          };
          e.prototype.componentWillLoad = function() {
            if (this.layout === undefined) {
              this.layout = i.get("tabButtonLayout", "icon-top");
            }
          };
          ...
          Object.defineProperty(e.prototype, "tabIndex", {
            get: function() {
              ...
              var e = this.el.hasAttribute("tabindex");
              if (e) {
          ...
          e.prototype.render = function() {
            ...
            var t = this,
              ...
              h = t.tab;
            var p = r(this);
            var y = { download: this.download, href: s, rel: b, target: c };
            return a(
              o,
              {
                ...
                role: "tab",
                tabindex: l,
                "aria-selected": f ? "true" : null,
                id: h !== undefined ? "tab-button-" + h : null,
                class:
                  ((e = {}),
                  (e[p] = true),
                  (e["tab-selected"] = f),
                  ...
                  (e["tab-has-label"] = u),
                  (e["tab-has-icon"] = i),
                  (e["tab-has-label-only"] = u && !i),
                  (e["tab-has-icon-only"] = i && !u),
                  (e["tab-layout-" + d] = true),
                  (e["ion-activatable"] = true),
                  (e["ion-selectable"] = true),
                  (e["ion-focusable"] = true),
                  e)
              },
              a(
                "a",
                Object.assign({}, y, { tabIndex: -1 }),
                a("slot", null),
                p === "md" && a("ion-ripple-effect", { type: "unbounded" })
              )
            );
          };
