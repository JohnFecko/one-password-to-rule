        ...
        (function() {
          function t(t) {
            ...
            this.onScroll = function() {
              ...
              var s = r.thrPc !== 0 ? o * r.thrPc : r.thrPx;
              var l = r.position === "bottom" ? n - e - i - s - o : i - e - s;
              if (l < 0) {
                if (!r.didFire) {
                  r.isLoading = true;
                  r.didFire = true;
            ...
            this.ionInfinite = i(this, "ionInfinite", 7);
          }
          t.prototype.thresholdChanged = function() {
            var t = this.threshold;
            if (t.lastIndexOf("%") > -1) {
              this.thrPx = 0;
              this.thrPc = parseFloat(t) / 100;
            } else {
              this.thrPx = parseFloat(t);
              this.thrPc = 0;
            }
          };
          ...
          t.prototype.render = function() {
            ...
            return s(a, {
              class:
                ((t = {}),
                (t[e] = true),
                (t["infinite-scroll-loading"] = this.isLoading),
                (t["infinite-scroll-enabled"] = !i),
                t)
            });
          };
