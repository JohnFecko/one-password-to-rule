...
const h = {
  ...
  o = class {
    ...
    visibleChanged(i) {
      const t = { visible: i, isPane: this.isPane.bind(this) };
      ...
      if (0 !== t.length) {
        if (window.matchMedia) {
          const i = i => {
            ...
            s = window.matchMedia(t);
          s.addListener(i),
            (this.rmL = () => s.removeListener(i)),
    ...
    styleChildren() {
      ...
      for (let n = 0; n < s; n++) {
        const s = t[n],
          a = void 0 !== i ? s.id === i : s.hasAttribute("main");
        if (a) {
          if (e)
      ...
      e || console.warn("split pane does not have a specified main node");
    }
    render() {
      const i = s(this);
      return e(a, {
  ...
  p = (i, t) => {
    let s, e;
    t
      ? ((s = "split-pane-main"), (e = "split-pane-side"))
      : ((s = "split-pane-side"), (e = "split-pane-main"));
    const n = i.classList;
    n.add(s), n.remove(e);
  };
export { o as ion_split_pane };
