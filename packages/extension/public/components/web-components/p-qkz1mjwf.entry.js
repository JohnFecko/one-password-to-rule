...
import { h as o, a as n, b as a } from "./p-cf171e41.js";
const c = class {
    constructor(i) {
      t(this, i),
        (this.lastToIndex = -1),
        ...
        (this.state = 0),
        (this.disabled = !0),
        (this.ionItemReorder = s(this, "ionItemReorder", 7));
    }
    disabledChanged() {
    ...
    onStart(t) {
      ...
      for (let t = 0; t < r.length; t++) {
        const s = r[t];
        i.push((h += s.offsetHeight)), (s.$ionIndex = t);
      }
      ...
      if (
        ...
        (this.scrollElInitial = this.scrollEl.scrollTop),
          (this.scrollElTop = t.top + u),
          (this.scrollElBottom = t.bottom - u);
      } else
        (this.scrollElInitial = 0),
          (this.scrollElTop = 0),
          (this.scrollElBottom = 0);
      (this.lastToIndex = d(s)),
        (this.selectedItemHeight = s.offsetHeight),
        (this.state = 1),
        s.classList.add(p),
        o();
    }
    onMove(t) {
      ...
      if (!s) return;
      const i = this.autoscroll(t.currentY),
        e = this.containerTop - i,
        r = Math.max(e, Math.min(t.currentY, this.containerBottom - i)),
        h = i + r - t.startY,
        o = this.itemIndexForTop(r - e);
      if (o !== this.lastToIndex) {
        const t = d(s);
        (this.lastToIndex = o), n(), this.reorderMove(t, o);
      }
      s.style.transform = `translateY(${h}px)`;
    }
    onEnd() {
      ...
      const s = this.lastToIndex,
        i = d(t);
      s === i
        ? ((t.style.transition = "transform 200ms ease-in-out"),
          (t.style.transform = ""),
    ...
    completeSync(t) {
      ...
      if (s && 2 === this.state) {
        ...
        r === h ||
          (t && !0 !== t) ||
          this.el.insertBefore(s, h < r ? i[r + 1] : i[r]),
          Array.isArray(t) && (t = m(t, h, r));
        for (let t = 0; t < e; t++) i[t].style.transform = "";
        (s.style.transition = ""),
    ...
    reorderMove(t, s) {
      ...
      for (let r = 0; r < e.length; r++) {
        ...
        r > t && r <= s
          ? (h = `translateY(${-i}px)`)
          : r < t && r >= s && (h = `translateY(${i}px)`),
          (e[r].style.transform = h);
      }
    }
    autoscroll(t) {
      ...
      let s = 0;
      return (
        t < this.scrollElTop ? (s = -f) : t > this.scrollElBottom && (s = f),
        0 !== s && this.scrollEl.scrollBy(0, s),
  ...
  l = (t, s) => {
    let i;
    for (; t; ) {
      if ((i = t.parentElement) === s) return t;
      t = i;
    }
  },
  u = 60,
  ...
  m = (t, s, i) => {
    const e = t[s];
    return t.splice(s, 1), t.splice(i, 0, e), t.slice();
  };
export { c as ion_reorder_group };
