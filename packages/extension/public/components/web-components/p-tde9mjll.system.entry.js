      ...
      var l = t(
        ...
        (function() {
          ...
          t.prototype.open = function(t) {
            return __awaiter(this, void 0, void 0, function() {
              ...
              return __generator(this, function(r) {
                ...
                if (t === undefined) {
                  t = e === this.leftOptions ? "start" : "end";
                }
                t = a(t) ? "end" : "start";
                i = this.openAmount < 0;
                n = this.openAmount > 0;
                if (i && e === this.leftOptions) {
                  return [2];
                }
                if (n && e === this.rightOptions) {
                  return [2];
                }
                this.closeOpened();
                this.state = 4;
                requestAnimationFrame(function() {
                  ...
                  var e =
                    t === "end" ? s.optsWidthRightSide : -s.optsWidthLeftSide;
                  p = s.el;
                  s.setOpenAmount(e, false);
                  s.state = t === "end" ? 8 : 16;
                });
                return [2];
              });
              ...
              return __generator(this, function(r) {
                switch (r.label) {
                  case 0:
                    ...
                    r.label = 1;
                  case 1:
                    if (!(i < t.length)) return [3, 4];
                    return [4, t.item(i).componentOnReady()];
                  case 2:
                    n = r.sent();
                    s = a(n.side) ? "end" : "start";
                    if (s === "start") {
                      this.leftOptions = n;
                      e |= 1;
                    } else {
          ...
          t.prototype.onMove = function(t) {
            ...
            var e = this.initialOpenAmount - t.deltaX;
            switch (this.sides) {
              case 2:
                e = Math.max(0, e);
                break;
            ...
            var i;
            if (e > this.optsWidthRightSide) {
              i = this.optsWidthRightSide;
              e = i + (e - i) * f;
            } else if (e < -this.optsWidthLeftSide) {
              i = -this.optsWidthLeftSide;
              e = i + (e - i) * f;
            }
            this.setOpenAmount(e, false);
          };
          t.prototype.onEnd = function(t) {
            ...
            var n = this.openAmount > 0 === !(e < 0);
            var s = Math.abs(e) > 0.3;
            var r = Math.abs(this.openAmount) < Math.abs(i / 2);
            if (d(n, s, r)) {
              i = 0;
            }
            var o = this.state;
            this.setOpenAmount(i, true);
            if ((o & 32) !== 0 && this.rightOptions) {
              this.rightOptions.fireSwipeEvent();
            } else if ((o & 64) !== 0 && this.leftOptions) {
          ...
          t.prototype.setOpenAmount = function(t, e) {
            var i = this;
            if (this.tmr !== undefined) {
              clearTimeout(this.tmr);
              this.tmr = undefined;
            ...
            if (t > 0) {
              this.state = t >= this.optsWidthRightSide + u ? 8 | 32 : 8;
            } else if (t < 0) {
              this.state = t <= -this.optsWidthLeftSide - u ? 16 | 64 : 16;
            } else {
          ...
          t.prototype.render = function() {
            ...
            return r(h, {
              class:
                ((t = {}),
                (t[e] = true),
                (t["item-sliding-active-slide"] = this.state !== 2),
                (t["item-sliding-active-options-end"] = (this.state & 8) !== 0),
                (t["item-sliding-active-options-start"] =
                  (this.state & 16) !== 0),
                (t["item-sliding-active-swipe-end"] = (this.state & 32) !== 0),
                (t["item-sliding-active-swipe-start"] =
                  (this.state & 64) !== 0),
                t)
            });
          };
