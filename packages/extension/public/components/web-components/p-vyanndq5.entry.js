import { r as t, d as i, e as s, h, f as e, H as n } from "./p-57e9347d.js";
import { i as o } from "./p-18f3dc7c.js";
let a;
const r = class {
    constructor(s) {
      t(this, s),
        ...
        (this.openAmount < 0 && i === this.leftOptions) ||
          ...
          requestAnimationFrame(() => {
            this.calculateOptsWidth(),
              (a = this.el),
              this.setOpenAmount(
                "end" === t ? this.optsWidthRightSide : -this.optsWidthLeftSide,
                !1
              ),
    ...
    async updateOptions() {
      ...
      for (let s = 0; s < t.length; s++) {
        const h = await t.item(s).componentOnReady();
        "start" == (o(h.side) ? "end" : "start")
          ? ((this.leftOptions = h), (i |= 1))
          : ((this.rightOptions = h), (i |= 2));
      }
    ...
    onMove(t) {
      ...
      let i,
        s = this.initialOpenAmount - t.deltaX;
      switch (this.sides) {
        case 2:
          s = Math.max(0, s);
          break;
      ...
      s > this.optsWidthRightSide
        ? (s = (i = this.optsWidthRightSide) + 0.55 * (s - i))
        : s < -this.optsWidthLeftSide &&
          (s = (i = -this.optsWidthLeftSide) + 0.55 * (s - i)),
        this.setOpenAmount(s, !1);
    }
    onEnd(t) {
      const i = t.velocityX;
      let s =
        this.openAmount > 0 ? this.optsWidthRightSide : -this.optsWidthLeftSide;
      const h = this.openAmount > 0 == !(i < 0),
        e = Math.abs(i) > 0.3,
        n = Math.abs(this.openAmount) < Math.abs(s / 2);
      d(h, e, n) && (s = 0);
      const o = this.state;
      this.setOpenAmount(s, !0),
        0 != (32 & o) && this.rightOptions
    ...
    setOpenAmount(t, i) {
      if (
        ...
        return;
      const s = this.item.style;
      if (((this.openAmount = t), i && (s.transition = ""), t > 0))
