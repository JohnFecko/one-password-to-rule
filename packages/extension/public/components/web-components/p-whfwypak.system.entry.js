      ...
      var i = t(
        ...
        (function() {
          ...
          t.prototype.componentWillLoad = function() {
            ...
            if (e) {
              e.classList.add("buttons-first-slot");
            }
            var r = t.reverse();
            var n =
              r.find(function(t) {
          ...
          t.prototype.childrenStyle = function(t) {
            ...
            var r = t.detail;
            var n = {};
            var o = this.childrenStyles.get(e) || {};
            var s = false;
          ...
          t.prototype.render = function() {
            ...
            return n(
              ...
              n("div", { class: "toolbar-background" }),
              n(
                "div",
                { class: "toolbar-container" },
                n("slot", { name: "start" }),
                n("slot", { name: "secondary" }),
                n("div", { class: "toolbar-content" }, n("slot", null)),
                n("slot", { name: "primary" }),
                n("slot", { name: "end" })
              )
            );
