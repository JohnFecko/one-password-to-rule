...
System.register(
  ...
  function(t) {
    "use strict";
    var e, r, n, i, o, s, a, u, c, l, d, f, h, p;
    return {
      setters: [
        function(t) {
          e = t.r;
      ...
      execute: function() {
        var v = function(t, e, r) {
          ...
          var i = new t();
          var o = e.host || e;
          var s = e.querySelector(".toast-wrapper");
          i.addElement(s);
          var a = "calc(-10px - var(--ion-safe-area-bottom, 0px))";
          var u = "calc(10px + var(--ion-safe-area-top, 0px))";
          switch (r) {
            case "top":
              i.fromTo("translateY", "-100%", u);
              break;
            case "middle":
              var c = Math.floor(o.clientHeight / 2 - s.clientHeight / 2);
              s.style.top = c + "px";
              i.fromTo("opacity", 0.01, 1);
              break;
            default:
              i.fromTo("translateY", "100%", a);
              break;
          }
        ...
        var m = function(t, e, r) {
          ...
          switch (r) {
            case "top":
              i.fromTo("translateY", u, "-100%");
              break;
            case "middle":
              i.fromTo("opacity", 0.99, 0);
              break;
            default:
              i.fromTo("translateY", a, "100%");
              break;
          }
          return Promise.resolve(
            n
        ...
        var b = function(t, e, r) {
          ...
          var s = e.querySelector(".toast-wrapper");
          i.addElement(s);
          var a = "calc(8px + var(--ion-safe-area-bottom, 0px))";
          var u = "calc(8px + var(--ion-safe-area-top, 0px))";
          switch (r) {
            case "top":
              s.style.top = u;
              i.fromTo("opacity", 0.01, 1);
        ...
        var y = function(t, e) {
          ...
          var n = new t();
          var i = e.host || e;
          var o = e.querySelector(".toast-wrapper");
          n.addElement(o);
        ...
        var w = t(
          ...
          (function() {
            ...
            t.prototype.present = function() {
              return __awaiter(this, void 0, void 0, function() {
                ...
                return __generator(this, function(e) {
                  switch (e.label) {
                    case 0:
                      return [4, a(this, "toastEnter", v, b, this.position)];
                    case 1:
                      e.sent();
                      if (this.duration > 0) {
                        this.durationTimeout = setTimeout(function() {
                          return t.dismiss(undefined, "timeout");
                        }, this.duration);
                      }
                      return [2];
                  }
            ...
            t.prototype.dismiss = function(t, e) {
              ...
              return u(this, t, e, "toastLeave", m, y, this.position);
            };
            ...
            t.prototype.getButtons = function() {
              ...
              if (this.showCloseButton) {
                e.push({
                  ...
                  handler: function() {
                    return t.dismiss(undefined, "cancel");
                  }
                });
              }
              return e;
            ...
            t.prototype.renderButtons = function(t, e) {
              var n;
              var o = this;
              if (t.length === 0) {
                return;
              ...
              var s = r(this);
              var a =
                ((n = { "toast-button-group": true }),
                (n["toast-button-group-" + e] = true),
                n);
              return i(
                "div",
                { class: a },
                t.map(function(t) {
                  return i(
                    ...
                    s === "md" &&
                      i("ion-ripple-effect", {
                        type:
                          t.icon !== undefined && t.text === undefined
                            ? "unbounded"
                            : "bounded"
                      })
                  );
            ...
            t.prototype.render = function() {
              ...
              var u = r(this);
              var c =
                ((t = { "toast-wrapper": true }),
                (t["toast-" + this.position] = true),
                t);
              return i(
                o,
                {
                  ...
                  i(
                    ...
                    i(
                      ...
                      this.header !== undefined &&
                        i("div", { class: "toast-header" }, this.header),
        ...
        var g = function(t) {
          ...
          return Object.assign(
            ...
            (e["toast-button-" + t.role] = t.role !== undefined),
