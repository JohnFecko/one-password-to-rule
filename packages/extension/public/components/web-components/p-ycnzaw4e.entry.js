...
import { h as e, o as l, c as b } from "./p-955ba954.js";
const r = class {
  constructor(i) {
    t(this, i),
      (this.activated = !1),
  ...
  render() {
    ...
    return o(
      n,
      {
        ...
        class: Object.assign({}, b(a), {
          [p]: !0,
          "fab-button-in-list": d,
          "fab-button-translucent-in-list": d && u,
          "fab-button-close-active": c,
          "fab-button-show": h,
          "fab-button-disabled": s,
          "fab-button-translucent": u,
          "ion-activatable": !0,
          "ion-focusable": !0,
      ...
      o(
        ...
        Object.assign({}, v, {
          ...
          onBlur: this.onBlur,
          onClick: t => l(r, t, this.routerDirection)
        }),
        o(
          "span",
          { class: "close-icon" },
          o("ion-icon", { name: "close", lazy: !1 })
        ),
        o("span", { class: "button-inner" }, o("slot", null)),
        "md" === p && o("ion-ripple-effect", null)
      )
    );
  }
  get el() {
