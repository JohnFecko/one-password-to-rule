System.register(
  ...
  function(e) {
    "use strict";
    var t, r, n, a, i, s, o, l, u, d, c, p, h, f;
    return {
      setters: [
        function(e) {
          t = e.r;
      ...
      execute: function() {
        var v = function(e, t) {
          var r = new e();
          var n = new e();
          n.addElement(t.querySelector("ion-backdrop"));
          var a = new e();
          a.addElement(t.querySelector(".alert-wrapper"));
          n.fromTo("opacity", 0.01, 0.3);
          a.fromTo("opacity", 0.01, 1).fromTo("scale", 1.1, 1);
          var i = r
            .addElement(t)
            .easing("ease-in-out")
            .duration(200)
        ...
        var b = function(e, t) {
          ...
          a.fromTo("opacity", 0.99, 0).fromTo("scale", 1, 0.9);
          var i = r
            .addElement(t)
            .easing("ease-in-out")
            .duration(200)
        ...
        var m = function(e, t) {
          ...
          a.fromTo("opacity", 0.01, 1).fromTo("scale", 0.9, 1);
          ...
          (function() {
            function e(e) {
              ...
              this.onBackdropTap = function() {
                a.dismiss(undefined, o);
              };
              this.dispatchCancelHandler = function(e) {
                var t = e.detail.role;
                if (l(t)) {
                  var r = a.processedButtons.find(function(e) {
                    return e.role === "cancel";
                  });
                  a.callButtonHandler(r);
                }
              };
            ...
            e.prototype.buttonsChanged = function() {
              var e = this.buttons;
              this.processedButtons = e.map(function(e) {
                return typeof e === "string"
                  ? {
                      text: e,
                      role: e.toLowerCase() === "cancel" ? "cancel" : undefined
                    }
                  : e;
              });
            };
            e.prototype.inputsChanged = function() {
              var e = this;
              var t = this.inputs;
              var r = new Set(
                t.map(function(e) {
              ...
              this.processedInputs = t.map(function(t, r) {
                return {
                  type: t.type || "text",
                  name: t.name || "" + r,
                  ...
                  checked: !!t.checked,
                  disabled: !!t.disabled,
                  id: t.id || "alert-input-" + e.overlayIndex + "-" + r,
                  handler: t.handler,
                  min: t.min,
                  max: t.max
                };
            ...
            e.prototype.present = function() {
              return u(this, "alertEnter", v, m);
            };
            e.prototype.dismiss = function(e, t) {
              return d(this, e, t, "alertLeave", b, y);
            };
            e.prototype.onDidDismiss = function() {
              return c(this.el, "ionAlertDidDismiss");
            };
            e.prototype.onWillDismiss = function() {
              return c(this.el, "ionAlertWillDismiss");
            };
            e.prototype.rbClick = function(e) {
              for (var t = 0, r = this.processedInputs; t < r.length; t++) {
                var n = r[t];
                n.checked = n === e;
              }
              this.activeId = e.id;
            ...
            e.prototype.cbClick = function(e) {
              e.checked = !e.checked;
              p(e.handler, e);
              this.el.forceUpdate();
            };
            e.prototype.buttonClick = function(e) {
              ...
              if (l(t)) {
                return this.dismiss({ values: r }, t);
              }
              var n = this.callButtonHandler(e, r);
              if (n !== false) {
                return this.dismiss(Object.assign({ values: r }, n), e.role);
              }
              return Promise.resolve(false);
            };
            e.prototype.callButtonHandler = function(e, t) {
              if (e && e.handler) {
                var r = p(e.handler, t);
                if (r === false) {
                  return false;
            ...
            e.prototype.getValues = function() {
              ...
              if (this.inputType === "radio") {
                var e = this.processedInputs.find(function(e) {
                  return !!e.checked;
                });
              ...
              var t = {};
              this.processedInputs.forEach(function(e) {
                t[e.name] = e.value || "";
              });
              return t;
            };
            e.prototype.renderAlertInputs = function(e) {
            ...
            e.prototype.renderCheckbox = function(e) {
              var t = this;
              var n = this.processedInputs;
              var i = r(this);
              if (n.length === 0) {
                return null;
              }
              return a(
                "div",
                { class: "alert-checkbox-group", "aria-labelledby": e },
                n.map(function(e) {
                  return a(
                    "button",
                    {
                    ...
                    a(
                      ...
                      a(
                        ...
                        a("div", { class: "alert-checkbox-inner" })
                      ),
                      a("div", { class: "alert-checkbox-label" }, e.label)
                    ),
                    i === "md" && a("ion-ripple-effect", null)
                  );
                })
              );
            };
            e.prototype.renderRadio = function(e) {
              var t = this;
              var r = this.processedInputs;
              if (r.length === 0) {
                return null;
              }
              return a(
                  ...
                  return a(
                    ...
                    a(
                      ...
                      a(
                        ...
                        a("div", { class: "alert-radio-inner" })
                      ),
                      a("div", { class: "alert-radio-label" }, e.label)
                    )
                  );
                })
              );
            };
            e.prototype.renderInput = function(e) {
              ...
              return a(
                "div",
                { class: "alert-input-group", "aria-labelledby": e },
                t.map(function(e) {
                  return a(
                    "div",
            ...
            e.prototype.renderAlertButtons = function() {
              var e = this;
              var t = this.processedButtons;
              var n = r(this);
              var i = {
              ...
              return a(
                ...
                t.map(function(t) {
                  return a(
                    ...
                    a("span", { class: "alert-button-inner" }, t.text),
                    n === "md" && a("ion-ripple-effect", null)
                  );
                })
              );
            };
              ...
              return a(
                i,
                {
                  ...
                  class: Object.assign(
                    ...
                    ((e = {}),
                    (e[l] = true),
                    (e["alert-translucent"] = this.translucent),
                    e)
                  ),
                  onIonAlertWillDismiss: this.dispatchCancelHandler,
                  onIonBackdropTap: this.onBackdropTap
                },
                a("ion-backdrop", { tappable: this.backdropDismiss }),
                a(
                  "div",
                  { class: "alert-wrapper" },
                  a(
                    "div",
                    { class: "alert-head" },
                    s && a("h2", { id: u, class: "alert-title" }, s),
                    o && a("h2", { id: d, class: "alert-sub-title" }, o)
                  ),
                  a("div", {
                    id: c,
                    class: "alert-message",
                    innerHTML: f(this.message)
                  }),
                  this.renderAlertInputs(p),
