  ...
  !(function(t) {
      ...
      var e = n(45),
        ...
        u = function(t, r, n, a, c, s, f, l) {
          for (var p, h = c, v = 0, g = !!f && i(f, l, 3); v < a; ) {
            if (v in n) {
              if (((p = g ? g(n[v], v, r) : n[v]), s > 0 && e(p)))
                h = u(t, r, p, o(p.length), h, s - 1) - 1;
              else {
    ...
    function(t, r, n) {
      ...
      t.exports = function(t) {
        ...
        if (
          ...
          for (n = new h((r = a(p.length))); r > y; y++)
            c(n, y, d ? g(p[y], y) : p[y]);
        else
          for (l = x.call(p), n = new h(); !(f = l.next()).done; y++)
        ...
        a = function(t) {
          return function(r, n, a) {
            ...
            return h <= l || "" == p
              ? f
              : ((c = h - l),
                (s = o.call(p, u(c / p.length))).length > c &&
                  (s = s.slice(0, c)),
                t ? f + s : s + f);
          };
        };
    ...
    function(t, r, n) {
      ...
      u(
        ...
        a(U, "URLSearchParams"),
        e({ global: !0, forced: !o }, { URLSearchParams: U }),
        ...
        { target: "Array", proto: !0, forced: !f("slice") },
        {
          slice: function(t, r) {
            ...
            if (
              ...
              return p.call(v, d, y);
            for (
              e = new (void 0 === n ? Array : n)(h(y - d, 0)), f = 0;
              d < y;
              d++, f++
            )
              d in v && s(e, f, v[d]);
        ...
        { target: "Array", proto: !0, forced: !f("splice") },
        {
          splice: function(t, r) {
            ...
            if (((f.length = e), n < e)) {
              ...
              for (h = y - e; h > x; h--)
                (g = h + n - 1),
                  (v = h + e - 1) in d ? (d[g] = d[v]) : delete d[g];
    ...
    function(t, r, n) {
      n(0)({ target: "Object", stat: !0 }, { is: n(97) });
    },
    function(t, r, n) {
      var e = n(0),
        o = n(1),
    ...
    function(t, r, n) {
      ...
      var e = n(0),
        o = n(100).end;
      e(
        { target: "String", proto: !0, forced: n(101) },
        {
          padEnd: function(t) {
            return o(this, t, arguments.length > 1 ? arguments[1] : void 0);
          }
            ...
            [
              ...
              function(t, o) {
                ...
                for (var b = 0, S = 0, w = []; S < p.length; ) {
                  ...
                  if (
                    null === O ||
                    (E = v(s(x.lastIndex + (g ? 0 : S)), p.length)) === b
                  )
                    S = c(p, S, d);
                  else {
        ...
        wt = function(t) {
          ...
          s.updateSearchParams(a.query),
            ...
            i ||
              ...
              (e.username = jt.call(e)),
              (e.password = Rt.call(e)),
              (e.host = kt.call(e)),
              (e.hostname = _t.call(e)),
              (e.port = Pt.call(e)),
...
var resourcesUrl = scriptElm
  ...
  : "";
var start = function() {
  var url = new URL("./p-aba13970.system.js", resourcesUrl);
